...
\newpage
		...
		\newcommand{\W}{.4\textwidth}
			\subfigure[Response time for Update on Student]
			{\includegraphics[width=\W]{figure/result/barplot-update_student-rt.pdf}}
			\subfigure[Throughput for Update on Student]
			{\includegraphics[width=\W]{figure/result/barplot-update_student-tp.pdf}}
			\caption{Performance updating students}\label{fres:update-user}
% 		\end{figure}
% \newpage	
% 	\subsection{Course} 
% 		\begin{figure}[H]
			\subfigure[Response time for Update on Course]
			{\includegraphics[width=\W]{figure/result/barplot-update_course-rt.pdf}}
			\subfigure[Throughput for Update on Course]
			{\includegraphics[width=\W]{figure/result/barplot-update_course-tp.pdf}}
			\caption{Performance updating courses}\label{fres:update-course}
% 		\end{figure}	
% \newpage	
% 	\subsection{Enrolment}
% 		\begin{figure}[H]
			\subfigure[Response time for Update on Enrolment]
			{\includegraphics[width=\W]{figure/result/barplot-update_enrolment-rt.pdf}}
			\subfigure[Throughput for Update on Enrolment]
			{\includegraphics[width=\W]{figure/result/barplot-update_enrolment-tp.pdf}}
			\caption{Performance updating enrolments}\label{fres:update-enrolment}
		\end{figure}
\clearpage
\newpage