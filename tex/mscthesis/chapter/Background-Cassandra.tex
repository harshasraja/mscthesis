...
configured to operate together and run as a single cluster~\citep{BOOK,datastax} 
.
...
and Amazon's Dynamo~\citep{Dynamo,ycsb}.  Over time, these adopted concepts
...
operations,  without any  master or slave nodes~\citep{BOOK,datastaxB}. 
...
way~\citep{Tai,henry,Vogel,ycsb}.
