...
\todo{Talk more about API, its components and the relationship between EM and
VH}
...
%  approach used in all the solutions to retrieve, process and access metadata
% are different since the metadata storage is unique in each solution. 
