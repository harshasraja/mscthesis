...
cloud~\citep{Shi,Florescu,Stonebraker,Abadi, Hackl}.
Unlike traditional \acp{DBMS}, cloud \acp{DBMS} are simple in their structure with minimum querying support and have a simple
...
various applications that users use.  Today,   cloud \acp{DBMS} are replicated, 
 distributed, simplified and often specialised~\citep{Cooper}.
...
database~\citep{DeWitt} (\todo{DeWitt et al. ,   n. d. )}. This eventually means
