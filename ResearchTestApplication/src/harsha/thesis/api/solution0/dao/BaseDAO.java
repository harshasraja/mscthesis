...
public class BaseDAO {
    ...
    /**
     * For reading the details of a particlar key. Returns only a single entity for this key.
     * For eg., returning the details where CoureID=SWEN100. Returns all columns for this key
     *
     * @param type
     * @param key
     * @return
     ...
     * @param columnName Which column name is expressed in the condition, eg, courseName
     * @param expression - Is it =, <,> etc.
     * @param columnValue -  what value are we checking for. eg., SWEN100
     * @param returnAllRows - True/False. True-returns all columns in result else returns only queried column eg., courseName
     * @return
