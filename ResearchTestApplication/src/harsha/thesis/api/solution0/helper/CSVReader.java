...
public class CSVReader {
	...
	public List<BaseEntity> getEntities(String csvFilePath, String entityType) throws URISyntaxException, IOException, ClassNotFoundException, IllegalArgumentException, InstantiationException, IllegalAccessException, InvocationTargetException, SecurityException, NoSuchMethodException{
	...
	private BaseEntity getEntity(String [] data) throws InstantiationException, IllegalAccessException, IllegalArgumentException, InvocationTargetException, SecurityException, NoSuchMethodException{
	...
	private void populateColumn(String[] data, BaseEntity tempEntity, String pkColumn) throws IllegalArgumentException, IllegalAccessException, InvocationTargetException, SecurityException, NoSuchMethodException{
		...
		for (int i=0; i<columnHeaders.length; i++) {
			...
			} /*else if ("KeyForUpdate".equals(columnHeaders[i].trim()) &&
					(null != data[i] ||
					"".equals(data[i].trim()))){
				Method method = tempEntity.getClass().getMethod("setKeyForUpdate", String.class);
				method.invoke(tempEntity, data[i]);
			}*/
		}
